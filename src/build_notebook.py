...
def create_notebook():
    ...
    # ----------------------------------------------------
    # Cell 5: Markdown Data Dictionary
    # ----------------------------------------------------
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
    ...
    # ----------------------------------------------------
    # Cell 7: Markdown Data Cleaning - Duplicates
    # ----------------------------------------------------
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
    ...
    # ----------------------------------------------------
    # Cell 9: Markdown Missing Value Handling Explanation
    # ----------------------------------------------------
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
    ...
    # ----------------------------------------------------
    # Cell 10: Code Missing Value Imputation
    # ----------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    # ----------------------------------------------------
    # Cell 12: Code Directory creation for images
    # ----------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    # ----------------------------------------------------
    # Cell 13: Code Visual 1: Target Distribution
    # ----------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    # ----------------------------------------------------
    # Cell 14: Markdown Visual 1 Insights
    # ----------------------------------------------------
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
    ...
    # ----------------------------------------------------
    # Cell 15: Code Visual 2: Applicant Income Distribution
    # ----------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    # ----------------------------------------------------
    # Cell 16: Markdown Visual 2 Insights
    # ----------------------------------------------------
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
    ...
    # ----------------------------------------------------
    # Cell 17: Code Visual 3: Loan Amount Distribution
    # ----------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    # ----------------------------------------------------
    # Cell 18: Markdown Visual 3 Insights
    # ----------------------------------------------------
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
    ...
    # ----------------------------------------------------
    # Cell 19: Code Visual 4: Credit History vs Loan Status
    # ----------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    # ----------------------------------------------------
    # Cell 20: Markdown Visual 4 Insights
    # ----------------------------------------------------
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
    ...
    # ----------------------------------------------------
    # Cell 21: Code Visual 5: Education vs Loan Status
    # ----------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    # ----------------------------------------------------
    # Cell 22: Markdown Visual 5 Insights
    # ----------------------------------------------------
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
    ...
    # ----------------------------------------------------
    # Cell 23: Code Visual 6: Income vs Loan Amount
    # ----------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    # ----------------------------------------------------
    # Cell 24: Markdown Visual 6 Insights
    # ----------------------------------------------------
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
    ...
    # ----------------------------------------------------
    # Cell 25: Code Visual 7: Correlation Analysis
    # ----------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    # ----------------------------------------------------
    # Cell 26: Markdown Visual 7 Insights
    # ----------------------------------------------------
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
    ...
    # ----------------------------------------------------
    # Cell 27: Markdown Feature Engineering Intro
    # ----------------------------------------------------
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
    ...
    # ----------------------------------------------------
    # Cell 28: Code Feature Engineering Application
    # ----------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    # ----------------------------------------------------
    # Cell 29: Markdown Preprocessing Intro
    # ----------------------------------------------------
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
    ...
    # ----------------------------------------------------
    # Cell 30: Code Preprocessing Encoding
    # ----------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    # ----------------------------------------------------
    # Cell 33: Markdown Model Training
    # ----------------------------------------------------
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
    ...
    # ----------------------------------------------------
    # Cell 35: Markdown Model Evaluation Explanation
    # ----------------------------------------------------
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
    ...
    # ----------------------------------------------------
    # Cell 36: Code Evaluation Helper Function
    # ----------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    # ----------------------------------------------------
    # Cell 37: Code Running Evaluation
    # ----------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    # ----------------------------------------------------
    # Cell 38: Code Plot Confusion Matrices
    # ----------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    # ----------------------------------------------------
    # Cell 40: Markdown Model Analysis & Best Model Explanation
    # ----------------------------------------------------
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
    ...
    # ----------------------------------------------------
    # Cell 41: Markdown Feature Importance Intro
    # ----------------------------------------------------
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
    ...
    # ----------------------------------------------------
    # Cell 42: Code Feature Importance Plot
    # ----------------------------------------------------
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    # ----------------------------------------------------
    # Cell 43: Markdown Feature Importance Discussion
    # ----------------------------------------------------
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
    ...
    # ----------------------------------------------------
    # Cell 44: Markdown Business Insights
    # ----------------------------------------------------
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
    ...
    # ----------------------------------------------------
    # Cell 45: Markdown Final Conclusions
    # ----------------------------------------------------
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
    ...
    # Save notebook to project root
    root_path = PROJECT_ROOT / "Loan_Default_Prediction.ipynb"
    with open(root_path, "w", encoding="utf-8") as f:
        json.dump(notebook, f, indent=2)
    print(f"Created notebook at: {root_path}")
    
    # Save notebook to notebooks/ folder
    notebooks_dir = PROJECT_ROOT / "notebooks"
    notebooks_dir.mkdir(exist_ok=True)
    nb_path = notebooks_dir / "Loan_Default_Prediction.ipynb"
